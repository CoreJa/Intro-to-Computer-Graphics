...
void main(){
    ...
    gl_Position = vec4(a_position.x+pos.x,
                       a_position.y+pos.y,
                       1,1);
...
function draw(gl,program,buffer,posX, posY) {
  ...
  let posAttributeLocation=gl.getUniformLocation(program,'pos');
  //send in the data of posX, posY
  gl.uniform2f(posAttributeLocation, posX,posY);
